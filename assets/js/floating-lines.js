/*=============== FLOATING LINES BACKGROUND (vanilla JS port, no React) ===============*/
/*
  Usage (see main.js):
    import { initFloatingLines } from './floating-lines.js';
    const fl = initFloatingLines(document.getElementById('floating-lines-bg'), {
    ...
    // fl.destroy() to tear down if ever needed
*/
import {
  Clock,
  Mesh,
...
export function initFloatingLines(container, options = {}) {
  ...
  if (!container) {
    throw new Error('initFloatingLines: container element is required');
  }
